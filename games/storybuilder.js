...
const GENRES = {
  ...
  scifi: {
    ...
    endings: [
      'What did technology make possible?',
      'How did they adapt to the future?',
  ...
  comedy: {
    ...
    endings: [
      'What was the hilarious misunderstanding?',
      'How did chaos lead to success?',
      'What was the ridiculous twist?'
    ]
  }
};
